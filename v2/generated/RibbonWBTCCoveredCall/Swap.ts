...
export class Swap__checkInputBidStruct extends ethereum.Tuple {
  get swapId(): BigInt {
...
export class Swap__swapOffersResult {
  value0: Address;
  value1: Address;
  value2: BigInt;
  value3: Address;
...
export class Swap extends ethereum.SmartContract {
  ...
  check(bid: Swap__checkInputBidStruct): Swap__checkResult {
    let result = super.call(
      "check",
  ...
  swapOffers(param0: BigInt): Swap__swapOffersResult {
    let result = super.call(
      "swapOffers",
    ...
    return new Swap__swapOffersResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toBigInt(),
      result[3].toAddress(),
  ...
  try_swapOffers(param0: BigInt): ethereum.CallResult<Swap__swapOffersResult> {
    let result = super.tryCall(
      "swapOffers",
      "swapOffers(uint256):(address,address,uint96,address,uint96,uint128,uint128,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
